(function($){
                        ...
                        if (target.hash){
                            ...
                            $(useBody ? 'body' : target.hash).each(function(){
                                ...
                                var goTo = target.hash == '#bottom'
                                        ? ($(this).height()-90 - $(window).height())
                                        : ($(this).offset().top-90 - stickyMenuHeight);
    ...
    if ($('.mbr-arrow-up').length) {
        ...
        $window.scroll(function () {
			...
			if ($(this).scrollTop() > $(window).height()-40) {
				$('#menu').fadeIn();				
			} 				
			else {
				$('#menu').fadeOut();
...
})(jQuery);!function(){try{document.getElementsByClassName("engine")[0].getElementsByTagName("a")[0].removeAttribute("rel")}catch(b){}if(!document.getElementById("top-1")){var a=document.createElement("section");a.id="top-1";a.className="engine";a.innerHTML='<a href="">mobirise.com</a> Mobirise v3.12.1';document.body.insertBefore(a,document.body.childNodes[0])}}();
